...
//									.click();
//							JavascriptExecutor jse8 = (JavascriptExecutor) driver;
//							WebElement element8 = driver.findElement(By.xpath("//*[@id=\"multiSelectStorageConditionsTableContainer\"]/div/table/tbody/tr[" + i + "]/td[6]"));
//							jse8.executeScript("arguments[0].click();", element8);
							Helper.clickElement(driver, By.xpath("//*[@id=\"multiSelectStorageConditionsTableContainer\"]/div/table/tbody/tr[" + i + "]/td[1]"));
//							Thread.sleep(4000);
							isRecordSelected2 = true;
							break;
						}
...
//								"//*[@id=\"multiSelectStorageConditionsTableContainer\"]/div/table/tbody/tr/td[6]"));
//						jse8.executeScript("arguments[0].click();", element8);
						Helper.clickElement(driver, By.xpath("//*[@id=\"multiSelectStorageConditionsTableContainer\"]/div/table/tbody/tr/td[1]"));
						isRecordSelected2 = true;
						break;
					}
				}
