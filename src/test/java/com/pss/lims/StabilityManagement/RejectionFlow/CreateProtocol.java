...
//		((JavascriptExecutor) driver).executeScript("document.body.style.zoom='90%';");
		...
		if (isRecordSelected1) {
			...
			WebElement element1 = driver.findElement(By.id("lifeCycleInScheduleTestSel"));
			jse1.executeScript("arguments[0].scrollIntoView(true);", element1);
			Thread.sleep(2000);
			Select lifeCycle = new Select(driver.findElement(By.id("lifeCycleInScheduleTestSel")));
			Thread.sleep(2000);
			lifeCycle.selectByVisibleText(properties.getProperty("Protocol_LifeCycle_Name"));
...
//			sno++;
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("batchSizeInProtForm_1")).sendKeys("100");
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("expDateInProtFormAPI_1")).sendKeys(expDate);
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Expiry Date", sno, false);
			Thread.sleep(2000);
			sno++;
			...
			if (isRecordSelected2) {
				...
				Thread.sleep(2000);
				sno++;
				driver.findElement(By.xpath("//*[@id=\"sampleDetailsKeptStabilityTableContainer\"]/div/table/tbody/tr/td[8]/button")).click();
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Add", sno, false);
				Thread.sleep(2000);
				sno++;
				driver.findElement(By.xpath("//*[@id=\"batchAndSCFieldsDetailsJtableInSampleDialog\"]/div/table/tbody/tr")).click();
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "select Batch", sno, false);
				Thread.sleep(2000);
				sno++;
...
//				sno++;
				...
				Thread.sleep(6000);
				sno++;
				driver.findElement(By.id("noOfRowsInScIntStrCondBoxForm")).sendKeys("1");
				...
				sno++;
				Thread.sleep(2000);
				driver.findElement(By.xpath("//*[@id=\"batchAndSCFieldsDetailsJtableInSchStrCondFormDialog\"]/div/table/tbody/tr")).click();
				...
				sno++;
				Thread.sleep(2000);
				Select Packtype = new Select(driver.findElement(By.id("packingTypeInPPPF_New_1")));
				...
				sno++;
				Thread.sleep(2000);
				Select Scheduleinterval = new Select(driver.findElement(By.id("scheduleIntervalInPPFF_New_1")));
				...
				sno++;
				Thread.sleep(2000);
				driver.findElement(By.id("rackNumberInScheduleStorageConditionsForm")).sendKeys(properties.getProperty("Interval"));
