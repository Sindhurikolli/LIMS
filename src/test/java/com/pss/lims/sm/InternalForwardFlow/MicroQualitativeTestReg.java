...
public class MicroQualitativeTestReg extends SMLoginDetails {

	@Test
	public void createMicroQualitativeTestReg() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CreateMicroQualitativeTestReg"
	...
	private void methodTocreateTest() throws Exception {
		...
		if (isRecordSelected) {
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("testNameInSmTest")).sendKeys(properties.getProperty("Micro_Test_Name"));
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("isMicroTestInSmTest")).click();
			document= Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select Is Micro Test", sno, false);
			Thread.sleep(3000);
			sno++;
			...
			Thread.sleep(2000);
			type.selectByVisibleText(properties.getProperty("TestTypeforQualitative"));
			...
			for (int i = 1; i <= noofVariables; i++) {
				...
				Thread.sleep(2000);//*[@id="qualitativeSubTestJsGrid"]/div[2]/table/tbody/tr[1]/td[1]/input
