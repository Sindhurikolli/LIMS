...
public class JobAllotment extends SMLoginDetails {
...
//			isRecordSelected1 = selectRecordForJobAllotment(count1, isRecordSelected1, arNumber);
			...
			String name2 = properties.getProperty("Test_Name");
	...
	private boolean selectRecordForJobAllotment(int count1, boolean isRecordSelected1, String arNumber)
		...
		if (perPageNoOfRecordsPresent > 0 && count1 == 0) {
			if ((totalNoOfRecords > 1) && ((arNumber == null) || ("".equalsIgnoreCase(arNumber)))) {
				arNumber = driver.findElement(By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr[1]/td[11]"))
						.getText();// documentType
			} else if ((arNumber == null) || ("".equalsIgnoreCase(arNumber))) {
				arNumber = driver.findElement(By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr/td[11]"))
						.getText();// document
									// type
			}
			++count1;
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String arNumberSequence = driver
								.findElement(By
										.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr[ " + i + " ]/td[11]"))
								.getText();// documentTypeName
						if (arNumber.equalsIgnoreCase(arNumberSequence)) {
							driver.findElement(
									By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr[ " + i + " ]/td[11]"))
									.click();
					...
					String arNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr/td[11]"))
							.getText();
					if (arNumber.equalsIgnoreCase(arNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr/td[11]"))
								.click();
						isRecordSelected1 = true;
						break;
					}
