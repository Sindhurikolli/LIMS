...
public class COAApprovalForwardWithMultipleTestsSelection extends SMLoginDetails {
	...
	public void approveCOA() throws Exception {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("a[href='coaAppPageInSample.do']")));
		...
		if (perPageNoOfRecordsPresent > 0) {
			while (noOfRecordsChecked < totalNoOfRecords) {
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					JavascriptExecutor js0 = (JavascriptExecutor)driver;
					WebElement imLinkText = driver.findElement(By.cssSelector("#sampleResultApprovalJtable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"));
					js0.executeScript("arguments[0].scrollIntoView();", imLinkText);
					Thread.sleep(3000);
