...
public class MultiTestsJobAllotment extends SMLoginDetails {
	...
	private boolean selectRecordForJobAllotment(int count1, boolean isRecordSelected1, String arNumber)
		...
		if (perPageNoOfRecordsPresent > 0 && count1 == 0) {
			if ((totalNoOfRecords > 1) && ((arNumber == null) || ("".equalsIgnoreCase(arNumber)))) {
				arNumber = driver.findElement(By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr[1]/td[13]"))
						.getText();// documentType
			} else if ((arNumber == null) || ("".equalsIgnoreCase(arNumber))) {
				arNumber = driver.findElement(By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr/td[13]"))
						.getText();// document
									// type
			}
			++count1;
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String arNumberSequence = driver
								.findElement(By
										.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr[ " + i + " ]/td[13]"))
								.getText();// documentTypeName
						if (arNumber.equalsIgnoreCase(arNumberSequence)) {
							driver.findElement(
									By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr[ " + i + " ]/td[13]"))
									.click();
					...
					String arNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr/td[13]"))
							.getText();
					if (arNumber.equalsIgnoreCase(arNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"jobAllotmentTable\"]/div/table/tbody/tr/td[13]"))
								.click();
						isRecordSelected1 = true;
						break;
					}
