...
public class ProductApproval extends SMLoginDetails {
	...
	public void approveProduct() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ApproveProduct" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Approve Product", "LIMS-SM-057", "Pass");
