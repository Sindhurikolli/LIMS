package com.pss.lims.Satbility.Login;
...
public class LoginDetails {
	...
	public void setUp() throws Exception {
		...
		if (propertiesFilePath != null) {
			...
			propertyFilePathName = "src/test/java/LIMSUIProperties/StabilityManagement.properties";
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("CALPMUIProperties.properties not found at " + propertyFilePath);
		}
