...
public class SMAssignRoles extends LIMSLogin {
	...
	@Test
	public void SMAssignRoleMethod() throws Exception {
	...
	private void toCreateUsers() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("a[href='assignRolePageInSample.do'")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("seluserBtnInAssignRolesInLIMS")).click();
		Thread.sleep(5000);
...
//		driver.findElement(By.id("locTreeInCalAssignRoles_2_span")).sendKeys(properties.getProperty("Location_Name"));
		Thread.sleep(5000);
		driver.findElement(By.id("searchFirstName")).sendKeys(properties.getProperty("SMFirstName"));
		Thread.sleep(1000);
		driver.findElement(By.id("searchLastName")).sendKeys(properties.getProperty("SMLastName"));
		Thread.sleep(1000);
		...
		if (driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[2]")).isDisplayed()) {
			...
			Thread.sleep(3000);
			String RoleName = properties.getProperty("SMRoleName");
			...
			if (ArrayUtils.contains(arrrolestoselect, RoleName)) {
				Roletoselect.selectByVisibleText(properties.getProperty("SMRoleName"));
				Thread.sleep(2000);
				JavascriptExecutor jse = (JavascriptExecutor) driver;
				jse.executeScript("window.scrollBy(0,250)");
				Thread.sleep(1000);
				driver.findElement(By.id("submitBtnInLimsAssignRole")).click();
				Thread.sleep(3000);
