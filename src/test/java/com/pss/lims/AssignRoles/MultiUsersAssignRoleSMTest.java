...
public class MultiUsersAssignRoleSMTest {
	...
	public void toMultiUserCreation(String FirstName, String LastName, String RoleName) throws Throwable {
		...
		properties.setProperty("SMFirstName", FirstName);
		properties.setProperty("SMLastName", LastName);
		properties.setProperty("SMRoleName", RoleName);
		properties.save();
	...
	public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
		...
		XSSFSheet sh = wb.getSheet("SampleRole");
