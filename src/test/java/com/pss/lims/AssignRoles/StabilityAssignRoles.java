...
public class StabilityAssignRoles extends LIMSLogin {

	@Test
	public void StabilityAssignRoleMethod() throws Exception {
		...
		Thread.sleep(1000);
		module.selectByVisibleText(properties.getProperty("ST_Module"));
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"loginform\"]/div[7]/input")).click();
		Thread.sleep(2000);
		WebDriverWait wait = new WebDriverWait(driver, 200);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='assignRolesInSM.do'")));
		JavascriptExecutor jse1 = (JavascriptExecutor) driver;
		WebElement element1 = driver.findElement(By.cssSelector("a[href='assignRolesInSM.do'"));
...
//		driver.findElement(By.id("locTreeInCalAssignRoles_2_span")).sendKeys(properties.getProperty("Location_Name"));
		Thread.sleep(5000);
		driver.findElement(By.id("searchFirstName")).sendKeys(properties.getProperty("STFirstName"));
		Thread.sleep(1000);
		driver.findElement(By.id("searchLastName")).sendKeys(properties.getProperty("STLastName"));
		Thread.sleep(1000);
		...
		if (driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[2]")).isDisplayed()) {
			...
			Thread.sleep(3000);
			String RoleName = properties.getProperty("STRoleName");
			...
			if (ArrayUtils.contains(arrrolestoselect, RoleName)) {
				Roletoselect.selectByVisibleText(properties.getProperty("STRoleName"));
				Thread.sleep(2000);
