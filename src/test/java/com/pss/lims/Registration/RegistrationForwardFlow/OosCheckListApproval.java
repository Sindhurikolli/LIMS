...
//import com.pss.lims.SampleManagement.Login.LoginDetails;
import com.pss.lims.login.RegistrationLoginDetails;
import com.pss.lims.util.HeaderFooterPageEvent;
import com.pss.lims.util.Utilities;

public class OosCheckListApproval extends RegistrationLoginDetails {
	@Test
	public void checkListApproval() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Approve OOS List", "PSS-LIMS-049", "Pass");
		...
		WebElement element1 = driver.findElement(By.cssSelector("a[href='oosListAppPageInSample.do']"));
		jse1.executeScript("arguments[0].scrollIntoView(true);", element1);
		jse1.executeScript("arguments[0].click();", element1);
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on OOS List", sno, false);
		Thread.sleep(4000);
		methodToApproveCheckList();
		document.close();
		writer.close();
	...
	private void methodToApproveCheckList() throws Exception {
		...
		if (isRecordSelected) {
			...
			Thread.sleep(3000);
			sno++;
			driver.findElement(By.id("commentInOOSAppWindw")).sendKeys(properties.getProperty("Approval_Comments"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Comments", sno, false);
			Thread.sleep(2000);
			sno++;
			JavascriptExecutor jse2 = (JavascriptExecutor) driver;
			WebElement element2 = driver.findElement(By.id("apprBtnInCategoryApproval"));
	...
	private boolean SelectRecordForCheckListApproval(int count, boolean isRecordSelected, String oosCheckList)
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"oOSListApprovalTable\"]/div/div[4]/div[2]/span"))
					.getText();
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((oosCheckList == null) || ("".equalsIgnoreCase(oosCheckList)))) {
				oosCheckList = driver
						.findElement(By.xpath("//*[@id=\"oOSListApprovalTable\"]/div/table/tbody/tr/td[3]")).getText();
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String oosCheckListSequence = driver
								.findElement(By
										.xpath("//*[@id=\"oOSListApprovalTable\"]/div/table/tbody/tr[" + i + "]/td[3]"))
								.getText();
						if (oosCheckList.equalsIgnoreCase(oosCheckListSequence)) {
							JavascriptExecutor jse = (JavascriptExecutor) driver;
							WebElement element = driver.findElement(By.xpath(
									"//*[@id=\"oOSListApprovalTable\"]/div/table/tbody/tr[" + i + "]/td[7]/button"));
					...
					String oosCheckListSequence = driver
							.findElement(By.xpath("//*[@id=\"oOSListApprovalTable\"]/div/table/tbody/tr/td[3]"))
							.getText();
					// *[@id="oOSListApprovalTable"]/div/table/tbody/tr[3]/td[3]
					if (oosCheckList.equalsIgnoreCase(oosCheckListSequence)) {
						JavascriptExecutor jse1 = (JavascriptExecutor) driver;
						WebElement element1 = driver.findElement(
								By.xpath("//*[@id=\"oOSListApprovalTable\"]/div/table/tbody/tr/td[7]/button"));
						jse1.executeScript("arguments[0].click()", element1);
						isRecordSelected = true;
						break;
					}
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#oOSListApprovalTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
