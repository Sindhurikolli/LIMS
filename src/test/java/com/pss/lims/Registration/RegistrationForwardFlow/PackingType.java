...
public class PackingType extends RegistrationLoginDetails {
	...
	public void createPackingType() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='packingTypesForm.do'")));
		JavascriptExecutor jse1 = (JavascriptExecutor) driver;
		WebElement element1 = driver.findElement(By.cssSelector("a[href='packingTypesForm.do']"));
...
//		Thread.sleep(2000);
		...
		sno++;
		JavascriptExecutor jse1 = (JavascriptExecutor) driver;
		WebElement element1 = driver.findElement(By.id("createPkgTypeAction"));
		jse1.executeScript("arguments[0].click();", element1);
		...
		Thread.sleep(5000);
		sno++;
		driver.findElement(By.id("packingTypeInLims")).sendKeys(properties.getProperty("Packing_Type_Name"));
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Packing Type", sno, false);
		Thread.sleep(2000);
		sno++;
		driver.findElement(By.name("packingTypeDescriptionInLims"))
				.sendKeys(properties.getProperty("Packing_Type_Description"));
