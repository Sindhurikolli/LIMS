...
public class QuantativeTestReg extends RegistrationLoginDetails {
	...
	private void methodTocreateTest() throws Exception {
		...
		if (isRecordSelected) {
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("testNameInSmTest")).sendKeys(properties.getProperty("Test_Name_Quantitative"));
